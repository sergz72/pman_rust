...
internal interface _UniFFILib : Library {
    ...
    fun uniffi_pman_lib_fn_func_open(`databaseId`: Long,`password`: RustBuffer.ByValue,`password2`: RustBuffer.ByValue,`keyFileContents`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): Unit
...
private fun uniffiCheckApiChecksums(lib: _UniFFILib) {
    ...
    if (lib.uniffi_pman_lib_checksum_func_open() != 54063.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
fun `open`(`databaseId`: ULong, `password`: String, `password2`: String?, `keyFileContents`: ByteArray?) =
    
    rustCallWithError(PmanException) { _status ->
    _UniFFILib.INSTANCE.uniffi_pman_lib_fn_func_open(FfiConverterULong.lower(`databaseId`),FfiConverterString.lower(`password`),FfiConverterOptionalString.lower(`password2`),FfiConverterOptionalByteArray.lower(`keyFileContents`),_status)
}
